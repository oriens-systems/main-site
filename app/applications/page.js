...
export default function ApplicationsPage() {
  ...
  const applications = [
    ...
    },
    {
      ...
      tagline: "Next-generation machinery for next-generation manufacturing",
      description:
        "Industrial automation demands components that can run millions of cycles without failure. High-performance gears, hydraulics, and robotics parts require precision that matches aerospace standards.",
      examples: [
        {
          name: "Precision Gear Sets",
          constraints: "Case-hardened steel, AGMA 12+, ground finish",
        },
        {
          name: "Hydraulic Valve Bodies",
          constraints:
            "Ductile iron/aluminum, spool-to-bore fit, pressure rated",
        },
        {
          name: "Robotic Arm Joints",
          constraints:
            "Aluminum 7000 series, integrated bearing races, zero-backlash",
        },
      ],
      stats: [
        { value: "10M+", label: "Cycle Life" },
        { value: "AGMA 12", label: "Gear Grade" },
        { value: "±5μm", label: "Accuracy" },
      ],
      icon: (
        <svg
          width="48"
