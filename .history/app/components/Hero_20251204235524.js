      ...
      <div className="relative z-10 flex flex-col justify-center min-h-screen px-8 md:px-12 lg:px-16 max-w-[1800px] mx-auto">
        <div className="pt-32 md:pt-40 lg:pt-32">
          ...
          <h1 className="flex flex-col gap-0">
            <span className="text-white text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-black uppercase leading-[0.95] tracking-tight">
              Reindustrializing
            </span>
            <span className="text-[#8B5CF6] text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-black uppercase leading-[0.95] tracking-[0.2em] md:tracking-[0.3em]">
              North America
            </span>
          </h1>
        </div>
