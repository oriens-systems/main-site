        ...
        <nav className="panel rounded-2xl px-4 md:px-6 py-3 flex items-center justify-between border border-white/10">
          <div className="flex items-center gap-3">
            ...
            <span className="text-white text-base md:text-lg font-semibold tracking-[0.18em]">
              SUPR<span className="text-[#7af0e3]">NOVA</span>
            </span>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="text-xs md:text-sm font-semibold text-[#7af0e3] border border-[#7af0e3]/60 rounded-full px-3 md:px-4 py-2 hover:bg-[#7af0e3]/10 transition-colors">
              Book time
            </button>
          </div>
        </nav>
