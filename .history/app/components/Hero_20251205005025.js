...
export default function Hero() {
  ...
  // Track scroll for bottom section - fade out when Mission section is 95% visible
  ...
  // Bottom section fades out when scrolled 95% into Mission section
  const bottomOpacity = useTransform(scrollYProgress, [0, 0.95], [1, 0]);
  ...
  return (
    ...
    >
      ...
      {/* Bottom Section - Fixed, fades at 95% of Mission visibility */}
      <motion.div 
        ref={bottomRef}
        className="fixed bottom-12 left-0 right-0 px-8 md:px-12 lg:px-16 z-20"
