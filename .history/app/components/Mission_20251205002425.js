      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 items-center min-h-screen max-w-[1800px] mx-auto px-8 md:px-12 lg:px-16 py-20 gap-8">
        ...
        >
          ...
          <p className="text-white/70 text-base md:text-lg leading-relaxed mb-10 max-w-xl">
            ...
            North America&apos;s Space & Defense industry by restricting the supply
            of precision metal components. Suprnova is launching a network of
            advanced, automated factories across Canada and the US to help Space
            & Defense manufacturers get precision components faster and at half
            the cost for rockets, satellites, jets, and drones.
          </p>
