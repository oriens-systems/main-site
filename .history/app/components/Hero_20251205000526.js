      ...
      <div className="relative z-10 flex flex-col items-start justify-center min-h-screen px-8 md:px-12 lg:px-16 max-w-[1800px] mx-auto">
        <div className="-mt-16 md:-mt-20">
          ...
          <h1 className="flex flex-col gap-0">
            <span className="text-white text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold uppercase leading-[0.95] tracking-tight">
              Reindustrializing
            </span>
            <span className="text-[#5900A7] text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold uppercase leading-[0.95] tracking-[0.2em] md:tracking-[0.3em]">
              North America
            </span>
          </h1>
        </div>
